...
var emailAdressInput = document.getElementById("email");
...
loginButton.onclick = function () {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, response, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    email = emailAdressInput.value.trim().toLowerCase();
                    password = loginpasswordInput.value;
                    return [4 /*yield*/, fetch("http://localhost:3006/api/authentication/login", {
                            method: 'POST',
                            headers: {
